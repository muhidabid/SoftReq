...
cluster = MongoClient("mongodb+srv://root:root@cluster0.8ay9n.mongodb.net/myFirstDatabase?retryWrites=true&w=majority", tlsCAFile=ca)
...
# -- creating posts
post = {"User": "Muhid", "US_raw": "The system should have blue and as the main color scheme", "time": str(datetime.now())}
...
db_retrieve = collection.find({"User": "Muhid"})
